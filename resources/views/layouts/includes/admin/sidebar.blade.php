...
>
  <!-- Ícono -->
  <span class="w-6 h-6 inline-flex justify-center items-center text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
    <i class="{{ $link['icon'] }}"></i>
  </span>

  <!-- Texto igual que el enlace normal -->
  <span class="ms-3">{{ $link['name'] }}</span>

  <!-- Chevron alineado a la derecha -->
  <svg
    class="w-3 h-3 ms-3 text-right transition-transform duration-200 group-[aria-expanded='true']:rotate-180"
    aria-hidden="true"
